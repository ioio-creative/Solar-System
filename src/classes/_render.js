...
export function RenderCelestialBody(props) {
  ...
  var period = props.celestialBody.period || "100"; //Period of orbit in ms/days whatever you choose
  var intensity = props.celestialBody.intensity; // Distance is intensity x distanceMultiplier (use generally for stars)
  var color = props.celestialBody.color || "#ffffff"; // Color of celestial object
